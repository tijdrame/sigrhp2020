...
describe('Service Tests', () => {
  describe('Motif Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(MotifService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Motif(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Motif', () => {
        ...
        service.create(new Motif()).subscribe(resp => (expectedResult = resp.body));

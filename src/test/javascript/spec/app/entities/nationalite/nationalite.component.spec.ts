...
import { NationaliteComponent } from 'app/entities/nationalite/nationalite.component';
...
describe('Component Tests', () => {
  describe('Nationalite Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.nationalites && comp.nationalites[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { StructureComponent } from 'app/entities/structure/structure.component';
...
describe('Component Tests', () => {
  describe('Structure Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.structures && comp.structures[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { AvantageCollabComponent } from 'app/entities/avantage-collab/avantage-collab.component';
...
describe('Component Tests', () => {
  describe('AvantageCollab Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.avantageCollabs && comp.avantageCollabs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

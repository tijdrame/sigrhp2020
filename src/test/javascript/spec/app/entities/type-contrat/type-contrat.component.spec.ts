...
import { TypeContratComponent } from 'app/entities/type-contrat/type-contrat.component';
...
describe('Component Tests', () => {
  describe('TypeContrat Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typeContrats && comp.typeContrats[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

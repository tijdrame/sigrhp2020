...
import { TypeAbsenceComponent } from 'app/entities/type-absence/type-absence.component';
...
describe('Component Tests', () => {
  describe('TypeAbsence Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typeAbsences && comp.typeAbsences[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

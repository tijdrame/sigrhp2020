...
import { DemandeCongeComponent } from 'app/entities/demande-conge/demande-conge.component';
...
describe('Component Tests', () => {
  describe('DemandeConge Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.demandeConges && comp.demandeConges[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
import { RemboursementComponent } from 'app/entities/remboursement/remboursement.component';
...
describe('Component Tests', () => {
  describe('Remboursement Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.remboursements && comp.remboursements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

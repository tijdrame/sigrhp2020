...
export class StructureComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.structureService
      ...
      .subscribe(
        (res: HttpResponse<IStructure[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IStructure): number {
  ...
  registerChangeInStructures(): void {
    this.eventSubscriber = this.eventManager.subscribe('structureListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IStructure[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

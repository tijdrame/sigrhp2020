...
export class PrimeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.primeService
      ...
      .subscribe(
        (res: HttpResponse<IPrime[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPrimes(): void {
    this.eventSubscriber = this.eventManager.subscribe('primeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPrime[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

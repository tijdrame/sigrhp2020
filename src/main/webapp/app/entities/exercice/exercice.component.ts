...
export class ExerciceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.exerciceService
      ...
      .subscribe(
        (res: HttpResponse<IExercice[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInExercices(): void {
    this.eventSubscriber = this.eventManager.subscribe('exerciceListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IExercice[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

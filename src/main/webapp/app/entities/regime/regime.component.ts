...
export class RegimeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.regimeService
      ...
      .subscribe(
        (res: HttpResponse<IRegime[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IRegime[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

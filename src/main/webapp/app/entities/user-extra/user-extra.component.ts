...
export class UserExtraComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.userExtraService
      ...
      .subscribe(
        (res: HttpResponse<IUserExtra[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInUserExtras(): void {
    this.eventSubscriber = this.eventManager.subscribe('userExtraListModification', () => this.loadPage());
  }

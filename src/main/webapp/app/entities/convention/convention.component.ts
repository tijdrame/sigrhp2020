...
export class ConventionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.conventionService
      ...
      .subscribe(
        (res: HttpResponse<IConvention[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IConvention): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInConventions(): void {
    this.eventSubscriber = this.eventManager.subscribe('conventionListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IConvention[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
